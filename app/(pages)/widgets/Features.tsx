      ...
      <Grid container spacing={4} justifyContent="center">
        ...
        <Grid item xs={12} md={2.4}>
          <Box textAlign="left">
            ...
            <Typography variant="body1">
              Can scale to millions of transactions on a sidechain tree architecture. 65k transactions/second on a single Matic chain.
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={12} md={2.4}>
          <Box textAlign="left">
            ...
            <Typography variant="body1">
              Smooth UX abstraction from mainchain to Matic chain. Native mobile apps and SDK with WalletConnect support.
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={12} md={2.4}>
          <Box textAlign="left">
            ...
            <Typography variant="body1">
              The Matic chain(s) operators are themselves Stakers and Delegates in a Proof-of-Stake system in the Matic Network.
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={12} md={2.4}>
