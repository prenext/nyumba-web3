...
const content: ContentItem[] = [
  {
    title: "Buy Land",
    description:
      "Easily and securely purchase your dream land with us, where endless possibilities await. Whether you're looking for a serene countryside retreat or a prime location for development, our platform provides you with the tools to make informed decisions. Embrace the freedom to choose your own piece of paradise.",
    image:
      "https://i.pinimg.com/564x/6d/47/1e/6d471e7cd5c59643ecf4585f4d95322c.jpg",
    details: [
      "Secure Purchase",
      "Flexible Terms",
      "Prime Locations",
  ...
  },
  {
    ...
    image:
      "https://i.pinimg.com/736x/7b/91/14/7b9114c5083292f4bd8ac0cbce9d41c9.jpg",
    details: [
      "Flexible Leasing",
      ...
      <Grid container alignItems="center" sx={{ marginBottom: 6 }}>
        <Grid item xs={12} md={8}>
          ...
          <Typography variant="subtitle1" sx={{ marginTop: 2, color: "#666" }}>
            Find the finest land at the most competitive prices with Acent: Our
            extensive inventory of premium properties offers value in prime
            locations.
          </Typography>
        </Grid>
        <Grid
